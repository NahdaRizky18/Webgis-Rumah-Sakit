...
Route::get('/panduan-user', [App\Http\Controllers\GuessController::class, 'panduanUser'])->name('panduan-user');
...
Route::get('/rute-user', [ App\Http\Controllers\UserController::class, 'ruteUser'])->name('rute user');
