...
@section('content')
    <div class="container">
        <div class="card p-4">
            <form action="{{ route('update puskesmas', ['id' => $id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input name="puskesmas" type="text" class="form-control" value="{{ $data->puskesmas }}"
                                >
                        </div>
                           ...
                           <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="radio" name="sedia" id="sedia" value="1" {{$data->ketersediaan ? 'checked':''}}>
                                    </div>
                                    <div class="col">
                                        <label for="tidak">
                                            Tidak Tersedia
                                        </label>
                                            <input type="radio" name="sedia" id="tidak" value="0" {{$data->ketersediaan == 0 ? 'checked':''}}>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Nomor</label>
                            <input name="no_hp" type="number" class="form-control" value="{{$data->no_hp}}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Klinik</label>
                            <input name="klinik" type="text" class="form-control" value="{{$data->klinik}}">
                        </div>
                        <div class="form-group">
