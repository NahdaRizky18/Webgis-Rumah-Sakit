...
@section('content')
    <div class="container">
        <div class="card p-4">
            <form action="{{ route('data puskesmas') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input name="puskesmas" type="text" class="form-control" >
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="radio" name="sedia" id="sedia" value="1">
                                    </div>
                                    <div class="col">
                                        <label for="tidak">
                                            Tidak Tersedia
                                        </label>
                                            <input type="radio" name="sedia" id="tidak" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                         <div class="form-group">
                            <label>Klinik</label>
                            <input name="klinik" type="text" class="form-control" >
                        </div>
                        <div class="form-group">
